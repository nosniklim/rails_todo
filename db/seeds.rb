...
# Create Cards
Card.create(id: 1,title: 'Feature #1', memo: 'things to do', list_id: 1, position: 1)
Card.create(id: 2,title: 'Feature #2', memo: 'things to do', list_id: 1, position: 2)
Card.create(id: 3,title: 'Feature #3', memo: 'things to do', list_id: 1, position: 3)
Card.create(id: 4,title: 'Feature #4', memo: 'things to do', list_id: 1, position: 4)
Card.create(id: 5,title: 'Feature #5', memo: 'things to do', list_id: 1, position: 5)

Card.create(id: 6,title: 'Feature #6', memo: 'things to do', list_id: 2, position: 1)
Card.create(id: 7,title: 'Feature #7', memo: 'things to do', list_id: 2, position: 2)
Card.create(id: 8,title: 'Feature #8', memo: 'things to do', list_id: 2, position: 3)
